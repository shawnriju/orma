...
export const sessionViewStyles = {
  ...
  navButtonPrev: 'p-3 rounded-full bg-white hover:bg-surface-container-low border border-outline-variant/40 text-outline hover:text-primary transition-all disabled:opacity-30 disabled:pointer-events-none shadow-sm shrink-0 flex items-center justify-center gap-1.5',
  navButtonNext: 'p-3 rounded-full bg-white hover:bg-surface border border-outline-variant/40 text-outline hover:text-primary transition-all disabled:opacity-30 disabled:pointer-events-none shadow-sm shrink-0 flex items-center justify-center gap-1.5',
  navIcon: 'w-5 h-5',
  hotkeyBadge: 'hidden md:inline-flex items-center justify-center px-1.5 py-0.5 text-[10px] font-semibold text-outline bg-surface-container border border-outline-variant/40 rounded font-mono',
  hotkeyBadgeDark: 'hidden md:inline-flex items-center justify-center px-1.5 py-0.5 text-[10px] font-semibold text-white/80 bg-white/10 border border-white/20 rounded font-mono ml-1.5',
  actionsRow: 'flex items-center justify-center mt-4 w-full',
  showAnswerButton: 'inline-flex items-center justify-center px-8 py-3 bg-primary-container text-white text-sm font-semibold rounded-xl shadow-sm hover:bg-primary transition-all active:scale-95 cursor-pointer gap-2',
